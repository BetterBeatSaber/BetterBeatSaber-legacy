...
public sealed class MenuSignBinding : MonoBehaviour {
    ...
    private void Start() {
        ...
        _eNeon = _flickeringNeonSign.GetField<FlickeringNeonSign, TubeBloomPrePassLight>("_light");
        _eLogo = _flickeringNeonSign.GetField<FlickeringNeonSign, SpriteRenderer>("_flickeringSprite");
    ...
    public void UpdateColors() {
        ...
        var color0 = RGB.Color0.WithAlpha(0.8f);
        var color1 = RGB.Color1.WithAlpha(0.8f);
    ...
    private static Color[] Steps(int stepsAmount) {
        ...
        var start = RGB.Color0.WithAlpha(.75f);
        var end = RGB.Color1.WithAlpha(.75f);
