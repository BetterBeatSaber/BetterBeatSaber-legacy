...
namespace BetterBeatSaber.Colorizer.Game.Utilities; 
...
public sealed class Outline : MonoBehaviour {
    ...
    private void FixedUpdate() {
        ...
        _fillMaterial.SetColor(ColorProperty, Core.Utilities.RGB.Color0);
        _fillMaterial.SetColor(Color1Property, Core.Utilities.RGB.Color1);
